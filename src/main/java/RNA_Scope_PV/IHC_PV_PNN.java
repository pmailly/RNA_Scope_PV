...
import static Tools.RNAScope_Tools3D.getPopFromImage;
                                ...
                                */
                                ...
                                for (int r = 0; r < rm.getCount(); r++) {
                                    ...
                                    if (roiName.contains(seriesName)) {
                                        ...
                                        // find PV cells                          
                                        Objects3DPopulation PVPop = findCells(imgPV, roi, 4, 6, 1, "MeanPlusStdDev", false, minCellVolPV, maxCellVolPV);
